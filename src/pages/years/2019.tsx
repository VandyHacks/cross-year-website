...
const events2019: React.FC<{}> = () => {
  const timelineItems = totalevents[1].Information.map(item => (
  ...
  return (
    <body
      style={{
        ...
        backgroundColor: totalevents[1].BackgroundColor
      }}
    >
      <div className="timeline-header">
        ...
        <div
          ...
          style={{ backgroundColor: `${totalevents[1].BackgroundColor}` }}
        >
