...
import members from './members_info.json';
  ...
  return (
    <Container className='about-content'>
      <TitleContainer>
        <Title>Members</Title>
        <p>
          The VandyHacks Board consists of 40+ organizers who are committed to creating learning
          experiences that are accessible and applicable to all. Meet the team below!
        </p>
      </TitleContainer>
      <MembersContainer>
            ...
            <MemberContainer>
              <ImageContainer className='zoom-image'>
                ...
                <MemberDesc>
                  ...
                  <Text>
                    <b>What do you like most about your committee?</b>
                  </Text>
                  <Text>{value.enjoy}</Text>
                  <Text>
                    <b>What's a fun fact about yourself?</b>
                  </Text>
