  ...
  return (
    <Container className="about-content">
      <TitleContainer>
        <Title>Members</Title>
        <p>
          The VandyHacks Board consists of 40+ organizers who are committed to
          creating learning experiences that are accessible and applicable to
          all. Meet the team below!
        </p>
      </TitleContainer>
      <MembersContainer>
